...
class TestBitmoneroRPC(unittest.TestCase):
    ...
    def setUp(self):
        ...
        info, err = self.bitmonero.get_info()
    ...
    def test_get_connections(self):
        ...
        connections, err = self.bitmonero.get_connections()
        T(connections, err)
    ...
    def test_get_block_count(self):
        ...
        block_count, err = self.bitmonero.get_block_count()
        T(block_count, err)
    ...
    def test_hard_fork_info(self):
        ...
        hard_fork_info, err = self.bitmonero.hard_fork_info()
        T(hard_fork_info, err)
    ...
    def test_get_last_block_header(self):
        ...
        last_block_header, err = self.bitmonero.get_last_block_header()
        T(last_block_header, err)
    ...
    def test_get_block_header_by_height(self):
        ...
        block_header, err = self.bitmonero.get_block_header_by_height(912345)
        T(block_header, err)
    ...
    def test_get_block_header_by_hash(self):
        ...
        block_header, err = self.bitmonero.get_block_header_by_hash("e22cf75f39ae720e8b71b3d120a5ac03f0db50bba6379e2850975b4859190bc6")
        T(block_header, err)
    ...
    def test_get_block_hash(self):
        ...
        block_hash, err = self.bitmonero.get_block_hash(912345)
        T(block_hash, err)
    ...
    def test_get_block_by_height(self):
        ...
        block, err = self.bitmonero.get_block_by_height(912345)
        T(block, err)
    ...
    def test_get_block_by_hash(self):
        ...
        # hash is for block 912345
        block, err = self.bitmonero.get_block_by_hash("e22cf75f39ae720e8b71b3d120a5ac03f0db50bba6379e2850975b4859190bc6")
        T(block, err)
    ...
    def test_get_transactions(self):
        ...
        transactions, err = self.bitmonero.get_transactions(txs_hashes)
        T(transactions, err)
    ...
    def test_get_block_template(self):
        ...
        reserve_size = 200
        block_template, err = self.bitmonero.get_block_template(address, reserve_size)
        T(block_template, err)
